...
function getWeather(cityname) {
  ...
  var queryURL =
    ...
    cityname +
    "&appid=7daff24a3e69fdc92c380db5a8ea82e4&units=imperial";
  $.ajax({
    url: queryURL,
    method: "GET",
    ...
    var queryURLforecast =
      ...
      "&lon=" +
      longitude +
      "&exclude={part}&appid=7daff24a3e69fdc92c380db5a8ea82e4&units=imperial";
...
//=======================CHANGE EVENT
$("#townSearch").on("keypress",function(event){
